      ...
      <div class="row">
        ...
        <div class="col-lg-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="#">PRE-REGISTRO DE ASPIRANTES</a>
              </h4>
              <p class="card-text">
                    <p>Aplicación Web 2.0 para el pre registro de aspirantes a ingresar al Centro de Formación y Desarrollo
                    Policial de la Policía Bancaria e Industrial.</p>
